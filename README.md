# Goobi workflow Plugin: goobi-plugin-dashboard-sample

<img src="https://goobi.io/wp-content/uploads/logo_goobi_plugin.png" align="right" style="margin:0 0 20px 20px;" alt="Plugin for Goobi workflow" width="175" height="109">

This is the Sample Goobi dashboard plugin. It is used as a reference implementation for future dashboard plugins. It does contain a configuration file and a simple user interface.
...
- Select as template `goobi-workflow/goobi-plugin-dashboard-sample`
- Select as `Owner` the value `goobi-workflow`
- Define a `Repository name` based on convention, e.g.  `goobi-plugin-dashboard-myPlugin`
...
- Open Eclipse and checkout the new created Repository. You will find a new project with the name `A-goobi-plugin-dashboard-sample` there.
- Right-click on the new project and refactor/rename it to your plugin name, e.g. `goobi-plugin-dashboard-myPlugin`
...
- The plugin is now created and ready to be used. Remember to commit your changes and don't forget to update the README.md file that is located on folder upwards of the eclipse project. As it does not get committed by Eclipse you can commit it with these commands:
  ...
  ```
  cd ~/git/goobi-plugin-dashboard-myPlugin
...
Detail | Description
--- | ---
**Plugin identifier**       | intranda_dashboard_sample
